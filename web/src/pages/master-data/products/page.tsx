...
import { Package, UserPlus, Layers, Weight, MoreHorizontal, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex justify-between items-end mb-8">
        ...
        >
          <UserPlus size={16} className="mr-2" /> Novo Produto
        </button>
      </div>
      ...
      <div className="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 text-[10px] uppercase font-bold text-gray-400 tracking-widest">
              ...
              <th className="px-6 py-4 border-b border-gray-200">Descrição do Item</th>
              <th className="px-6 py-4 border-b border-gray-200 text-center">UM / Tipo</th>
          ...
          <tbody className="text-sm text-gray-600">
            {filteredProducts.map((product: any) => (
              ...
              >
                <td className="px-6 py-4 text-center font-mono text-[10px] text-gray-400 uppercase">
                  {product.codigo}
                </td>
        ...
        <div className="bg-gray-50 px-6 py-3 border-t border-gray-200 text-[10px] text-gray-400 font-bold uppercase tracking-widest">
          Total SB1: {filteredProducts.length}
        </div>
      </div>
